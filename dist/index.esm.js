...
const Square = memo(function Square({ children, squareId, isLightSquare, isOver, }) {
    ...
    return (jsxs("div", { id: `${id}-square-${squareId}`, style: {
            ...
            piece: currentPosition[squareId] ?? null,
            square: squareId,
        }), children: [showNotation && !(showMargin && coordinatesOnMargin) ? (jsxs("span", { style: isLightSquare
                    ? {
...
function Board() {
    ...
    const renderMarginCoordinates = () => {
        ...
        return (jsxs(Fragment$1, { children: [notationSides.top && (jsx("div", { style: {
                        gridColumn: '2',
                        gridRow: '1',
                        display: 'flex',
                        ...
                        gridRow: '1',
                        backgroundColor: marginOptions.color,
                    } })), !notationSides.bottom && (jsx("div", { style: {
                        gridColumn: '2',
                        gridRow: '3',
                        backgroundColor: marginOptions.color,
                    } })), !notationSides.left && (jsx("div", { style: {
                        gridColumn: '1',
                        gridRow: '2',
                        backgroundColor: marginOptions.color,
                    } })), !notationSides.right && (jsx("div", { style: {
                        gridColumn: '3',
                        gridRow: '2',
                        backgroundColor: marginOptions.color,
                    } }))] }));
    ...
    return (jsxs(Fragment$1, { children: [jsxs("div", { style: containerStyle, children: [showMargin && renderMarginCoordinates(), jsx("div", { style: boardContainerStyle, children: jsxs("div", { id: `${id}-board`, style: {
