...
const defaultMarginNotationStyle = {
    fontSize: '12px',
    fontWeight: 'bold',
    color: '#333',
    userSelect: 'none',
...
function ChessboardProvider({ children, options, }) {
    ...
    // margin
    marginOptions = defaultMarginOptions, showMargin = false, coordinatesOnMargin = true, marginNotationStyle = defaultMarginNotationStyle, notationSides = defaultNotationSides, 
    // animation
...
const Square = React.memo(function Square({ children, squareId, isLightSquare, isOver, }) {
    const { id, allowDrawingArrows, boardOrientation, chessboardColumns, chessboardRows, currentPosition, squareStyle, squareStyles, darkSquareStyle, lightSquareStyle, dropSquareStyle, darkSquareNotationStyle, lightSquareNotationStyle, alphaNotationStyle, numericNotationStyle, showNotation, showMargin, coordinatesOnMargin, onMouseOutSquare, onMouseOverSquare, onSquareClick, onSquareMouseDown, onSquareMouseUp, onSquareRightClick, squareRenderer, newArrowStartSquare, setNewArrowStartSquare, setNewArrowOverSquare, drawArrow, clearArrows, } = useChessboardContext();
    ...
    return (jsxRuntime.jsxs("div", { id: `${id}-square-${squareId}`, style: {
            ...
            piece: currentPosition[squareId] ?? null,
            square: squareId,
        }), children: [showNotation && !(showMargin && coordinatesOnMargin) ? (jsxRuntime.jsxs("span", { style: isLightSquare
                    ? {
...
function Board() {
    const { allowDragOffBoard, board, boardStyle, chessboardColumns, chessboardRows, boardOrientation, currentPosition, draggingPiece, id, marginOptions, showMargin, coordinatesOnMargin, marginNotationStyle, notationSides, } = useChessboardContext();
    const renderMarginCoordinates = () => {
        if (!showMargin || !coordinatesOnMargin)
            return null;
        const files = [];
        const ranks = [];
        ...
        return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [notationSides.top && (jsxRuntime.jsx("div", { style: {
                        ...
                        gridRow: '1',
                        backgroundColor: marginOptions.color,
                    } })), !notationSides.bottom && (jsxRuntime.jsx("div", { style: {
                        gridColumn: '2',
                        gridRow: '3',
                        backgroundColor: marginOptions.color,
                    } })), !notationSides.left && (jsxRuntime.jsx("div", { style: {
                        gridColumn: '1',
                        gridRow: '2',
                        backgroundColor: marginOptions.color,
                    } })), !notationSides.right && (jsxRuntime.jsx("div", { style: {
                        gridColumn: '3',
                        gridRow: '2',
                        backgroundColor: marginOptions.color,
                    } }))] }));
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsxs("div", { style: containerStyle, children: [showMargin && renderMarginCoordinates(), jsxRuntime.jsx("div", { style: boardContainerStyle, children: jsxRuntime.jsxs("div", { id: `${id}-board`, style: {
...
exports.defaultMarginNotationStyle = defaultMarginNotationStyle;
exports.defaultMarginOptions = defaultMarginOptions;
exports.defaultNotationSides = defaultNotationSides;
